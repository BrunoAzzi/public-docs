...
# Retrieve the OpenAI API Key from user input
...
if uploaded_file is not None and user_ai_key and analyze_button:
    ...
    with st.spinner("Analysing the image ..."):
        ...
        prompt_text = (
            ...
            "Provide a structured json with the text extracted from the document."
        )
